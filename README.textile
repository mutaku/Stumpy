...
# Generate your SECRET_KEY by running gimme_key.py [python gimme_key.py].
...
# Sync the database to the models [python manage.py syncdb].
# Fire up the server [python manage.py runserver] and navigate to /admin in your browser. Go to sites->sites and edit the domain name to match the domain you are using. This will initially be set to 'example.com'.
