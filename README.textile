...
# If you do not have a SECRET_KEY generated in Django you will need to generate your SECRET_KEY by running the keygen script and copy that key into your local_settings.py file in the next step. 
