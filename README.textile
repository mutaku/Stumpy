...
bc. git clone https://mutaku@github.com/mutaku/Stumpy.git

# Setup a mysql database that stumpy can access.
bc. create database stumpy;grant all on stumpy.* to 'SOMEUSER@localhost' identified by "SOMEPASS";flush privilieges;
